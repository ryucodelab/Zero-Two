...
def inlinequery(update: Update, _) -> None:
    ...
    if (f := query.split(" ", 1)[0]) in inline_funcs:
        ...
        inline_help_dicts = [
            ...
            #},
            {
                "title": "Account info on Zero Two",
                "description": "Look up a Telegram account in Zero Two database",
                "message_text": "Click the button below to look up a person in Zero Two database using their Telegram ID",
                "thumb_urL": "https://telegra.ph/file/c85e07b58f5b3158b529a.jpg",
                "keyboard": ".info ",
            },
            {
                "title": "About",
                "description": "Know about Zero Two",
                "message_text": "Click the button below to get to know about Zero Two.",
                "thumb_urL": "https://telegra.ph/file/c85e07b58f5b3158b529a.jpg",
                "keyboard": ".about ",
            },
            {
...
def inlineinfo(query: str, update: Update, context: CallbackContext) -> None:
    ...
    if user.id == OWNER_ID:
        ...
        text += "\\n\\nThis Person is a part of Blue Blood Union"
        nation_level_present = True
    ...
    kb = InlineKeyboardMarkup([[InlineKeyboardButton(text="Report Error", url="https://t.me/pbshinigami"), InlineKeyboardButton(text="Search again", switch_inline_query_current_chat=".info ",)]])
...
def about(query: str, update: Update, context: CallbackContext) -> None:
    ...
    """
    results: list = []
    kb = InlineKeyboardMarkup([[InlineKeyboardButton(text="Support", url="https://t.me/pbshinigami"), InlineKeyboardButton(text="Channel", url="https://t.me/ZeroTwoUpdates"), InlineKeyboardButton(text='Ping', callback_data='pingCB')], [InlineKeyboardButton(text="GitHub", url="https://github.com/ryucodelab/Zero-Two",)]])
    ...
    results.append(
        ...
        InlineQueryResultArticle
            (
            id=str(uuid4()),
            title=f"About Zero Two (@{context.bot.username})",
...
def media_query(query: str, update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        kb = InlineKeyboardMarkup([[InlineKeyboardButton(text="Report error", url="t.me/pbshinigami"), InlineKeyboardButton(text="Search again", switch_inline_query_current_chat=".anilist ")]])
