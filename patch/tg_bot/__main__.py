...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        # kb.append([InlineKeyboardButton(text='Support', url='https://t.me/pbshinigami'),
                    ...
                    [
                        [
                            ...
                            InlineKeyboardButton(
                                ...
                                url="https://github.com/ryucodelab/Zero-Two",
                            ),
                        ],
                        [
                            InlineKeyboardButton(
            ...
            if args[0].lower() == "help":
                ...
                help_buttons.append(
                    [
                        ...
                        InlineKeyboardButton(
                            text="Support", url="https://t.me/pbshinigami"
                        ),
                    ]
                )
                send_help(
...
def main():
    ...
    if WEBHOOK:
        ...
        logging.info(
            f"Zero Two started, Using webhooks. | BOT: [@{dispatcher.bot.username}]"
        )

    else:
        logging.info(
            f"Zero Two started, Using long polling. | BOT: [@{dispatcher.bot.username}]"
        )
        ZeroTwoINIT.bot_id = dispatcher.bot.id
        ZeroTwoINIT.bot_username = dispatcher.bot.username
        ZeroTwoINIT.bot_name = dispatcher.bot.first_name
...
if __name__ == "__main__":
    logging.info("[ZEROTWO] Successfully loaded modules: " + str(ALL_MODULES))
